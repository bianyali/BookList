; Exercise 2.15
; find a better program for parallel resistences
;
...
(if (< (center (par1 (make-interval 1 2)
                     (make-interval 3 4)))
       (center (par2 (make-interval 1 2)
                     (make-interval 3 4))))
    (display "par1 is a better program for parallel resistences than par2.")
    (display "par2 is a better program for parallel resistences than par1."))
